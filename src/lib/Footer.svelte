...
<footer class="{outOfDate ? '' : 'invisible'}" bind:this={elNeedUpdate}>
	<p class="updateNotice">There is an update available for your League Page. <a href="https://github.com/otey247/league-page/blob/master/TRAINING_WHEELS.md#iv-updates">Follow the Update Instructions</a> to get all of the newest features!</p>
	<div id="navigation">
		<ul>
			{#each tabs as tab}
				{#if !tab.nest}
	...
	<span class="copyright">&copy; 2021 - {year} <a href="https://github.com/otey247/league-page">Lots of Shots League Page</a></span>
	<br />
	<!-- PLEASE DO NOT REMOVE THE BUILT BY -->
	<span class="creator">Built by <a href="http://www.devourdata.com/">Jo Otey</a><br /></span>
</footer>
...
<footer class="{!outOfDate ? '' : 'invisible'}" bind:this={el}>
	...
	<!-- PLEASE DO NOT REMOVE THE COPYRIGHT -->
	<span class="copyright">&copy; 2021 - {year} <a href="https://github.com/otey247/league-page">League Page</a></span>
	<br />
	<!-- PLEASE DO NOT REMOVE THE BUILT BY -->
	<span class="creator">Built by <a href="http://www.devourdata.com/">Jo Otey</a><br /></span>
</footer>
